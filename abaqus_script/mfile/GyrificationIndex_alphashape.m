function [connectivity_hull, vertices_hull,GI]= GyrificationIndex_alphashape(connectivity_surf,x,y,z)
...
shp = alphaShape(Points_set,13);
[connectivity_hull, vertices_hull]=boundaryFacets(shp);
